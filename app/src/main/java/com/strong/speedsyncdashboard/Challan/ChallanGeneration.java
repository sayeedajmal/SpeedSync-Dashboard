...
public class ChallanGeneration {
    ...
    public static void GenerateChallan(Context context, String carNumber, String email, String Highway, float currentSpeed, Location location, Map<String, Object> info, ChallanGenerationCallback callback) {
        Gson json = new Gson();
        VehicleInfo vehicleInfo = new VehicleInfo(carNumber, email, Highway, currentSpeed, location, info);
